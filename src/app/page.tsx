  ...
  return (
    <>
      ...
      <section className="bg-white flex flex-col">
        ...
        */}
        <div className="flex-1 grid grid-cols-1 items-start text-center pt-8 pb-0 px-5 md:grid-cols-[1fr_46vw] md:items-center md:text-left md:pt-[4.5rem] md:pb-20 md:pl-[clamp(1.5rem,5vw,7rem)] md:pr-0 lg:grid-cols-[1fr_52vw] xl:grid-cols-[1fr_62vw]">
          ...
          <div className="hero-visual pb-12 pt-6 md:pt-0 md:pb-0">
            <Image
